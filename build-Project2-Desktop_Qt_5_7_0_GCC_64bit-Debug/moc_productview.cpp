...
#include "../Project2/productview.h"
...
struct qt_meta_stringdata_productView_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_productView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_productView_t qt_meta_stringdata_productView = {
    {
QT_MOC_LITERAL(0, 0, 11), // "productView"
QT_MOC_LITERAL(1, 12, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "productView\0on_pushButton_clicked\0"
};
...
const QMetaObject productView::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_productView.data,
      qt_meta_data_productView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *productView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_productView.stringdata0))
