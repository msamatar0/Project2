...
#include "../Project2/ratingscreen.h"
...
struct qt_meta_stringdata_ratingscreen_t {
    QByteArrayData data[4];
    char stringdata0[58];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ratingscreen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ratingscreen_t qt_meta_stringdata_ratingscreen = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ratingscreen"
QT_MOC_LITERAL(1, 13, 21), // "on_rateButton_clicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 21) // "on_backButton_clicked"

    },
    "ratingscreen\0on_rateButton_clicked\0\0"
...
void ratingscreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_rateButton_clicked(); break;
...
const QMetaObject ratingscreen::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ratingscreen.data,
      qt_meta_data_ratingscreen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ratingscreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ratingscreen.stringdata0))
